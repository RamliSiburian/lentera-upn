        ...
        >
          ...
          {sidebarOpen && (
            <div className="overflow-hidden">
              <div className="text-white font-bold text-[13px] tracking-wider leading-tight">LENTERA</div>
              <div className="text-[9.5px] tracking-[0.12em] uppercase" style={{ color: 'rgba(255,255,255,0.40)' }}>
